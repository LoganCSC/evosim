...
public class CollisionObserver : MonoBehaviour {
	...
	public void observe (GameObject a, GameObject b) {
		...
		CollEvent bumped = findMatch(a, b);
		// If a duplicatd (bumped) event has been found spawn a child by mating the two bumped creatures
		if (null != bumped) {
			...
			Creature crt1 = a.transform.parent.parent.GetComponent<Creature>();
			Creature crt2 = b.transform.parent.parent.GetComponent<Creature>();
